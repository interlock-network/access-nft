            ...
            socket.on('ascii-art', (art) => {
              ...
              (async () => {
                ...
                console.log('');
								...
								// notify access area depending on choice
                if (something) {
                  ...
                  socket.emit('do-something-useless');
						...
						// confirmation that privileged user did something useful
            socket.on('did-something-useful', (result) => {
              ...
              (async () => {
                ...
                process.exit();
						...
						// confirmation that privileged user did something useless
